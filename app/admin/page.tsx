    ...
    <div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          {[
            { plan: 'Free',  count: byPlan.free,  color: 'bg-slate-100 text-slate-700' },
            { plan: 'Basic', count: byPlan.basic, color: 'bg-blue-100 text-blue-700' },
            { plan: 'Pro',   count: byPlan.pro,   color: 'bg-purple-100 text-purple-700' },
